#include <math.h>  // Include the math library to use the sqrt() and cos() functions.

double compute_numerical_error(int nx, int ny, double dx, double dy, double t_value, double **u) {
